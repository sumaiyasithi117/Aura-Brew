...
To get the Aura Brew experience on your phone immediately:
    ...
    Download: Click the Latest APK button above.
    Install: Open the downloaded .apk file.
    Permissions: If prompted, allow "Install from Unknown Sources".
    Login: Use the pre-configured admin credentials provided by the developer.
...
🔌 API Hosting (Render)
    ...
    URL: https://aura-brew.onrender.com
